...
#include "flash_bwd_kernel_hdim96_32x64_4waves.h"
#include "flash_bwd_kernel_hdim96_16x64.h"
#include "flash_bwd_kernel_hdim128_32x64.h"
#include "flash_bwd_kernel_hdim128_32x128.h"
#include "flash_bwd_kernel_hdim256.h"

#include "flash_bwd_kernel_k64.h"
#include "flash_bwd_kernel_k32_blockN128.h"
#include "flash_bwd_kernel_k32_32x32.h"
...
inline __device__ void compute_dq_dk_dv_1colblock(const Params &params, const int bidb, const int bidh, const int n_block) {
    ...
    for (; m_block >= m_block_min; --m_block) {
        ...
        if (Is_dropout) {
            ...
            dropout.template mc_apply_dropout</*encode_dropout_in_sign_bit=*/true, AtomLayoutMS, /*AtomLayoutNS*/1, kBlockN>(
        ...
        for (n_block = blockIdx.x; n_block < (params.seqlen_k + kBlockN - 1) / kBlockN; n_block += gridDim.x) {
            if constexpr(kHeadDim == 64){
                if constexpr (kBlockN == 128) {
                    compute_dq_dk_dv_1colblock_k32_blockN128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
                } else if constexpr (kNWarps == 4) {
                    compute_dq_dk_dv_1colblock_hdim64_64x64_4waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
                }
            } else if constexpr (kHeadDim == 128) {
                if constexpr (kBlockM == 32 && kBlockN == 64) {
                    compute_dq_dk_dv_1colblock_hdim128_32x64<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                } else if constexpr (kBlockM == 32 && kBlockN == 128) {
                    compute_dq_dk_dv_1colblock_hdim128_32x128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                }
            } else if constexpr (kHeadDim == 96) {
                if constexpr (kNWarps == 4) {
                    compute_dq_dk_dv_1colblock_hdim96_32x64_4waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                } else if constexpr (kNWarps == 2) {
                    compute_dq_dk_dv_1colblock_hdim96_16x64_2waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                }
            } else if constexpr (kHeadDim == 192) {
                compute_dq_dk_dv_1colblock_k64<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
            } else if constexpr (kHeadDim == 256) {
                compute_dq_dk_dv_1colblock_hdim256_32x32_8wave<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
                ...
                compute_dq_dk_dv_1colblock<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
            }
        }
    }else {
        ...
        if constexpr(kHeadDim == 64){
            ...
            if constexpr (kBlockM == 32 && kBlockN == 64){
                ...
                if constexpr (Is_balance) {
                    compute_dq_dk_dv_1colblock_hdim128_32x64<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
                }
            } else if constexpr (kBlockM == 32 && kBlockN == 128) {
                compute_dq_dk_dv_1colblock_hdim128_32x128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                if constexpr (Is_balance) {
                    compute_dq_dk_dv_1colblock_hdim128_32x128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
                }
            }
        }else if constexpr (kHeadDim == 96) {
            if constexpr (kNWarps == 4) {
                compute_dq_dk_dv_1colblock_hdim96_32x64_4waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                if constexpr (Is_balance) {
                    compute_dq_dk_dv_1colblock_hdim96_32x64_4waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
                }
            } else if constexpr(kNWarps == 2) {
                compute_dq_dk_dv_1colblock_hdim96_16x64_2waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block);
                if constexpr (Is_balance) {
                    compute_dq_dk_dv_1colblock_hdim96_16x64_2waves<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
                }
            }
            ...
            compute_dq_dk_dv_1colblock_k64<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
            if constexpr (Is_balance) {
                compute_dq_dk_dv_1colblock_k64<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
            }
        } else if constexpr (kHeadDim == 256) {
            compute_dq_dk_dv_1colblock_hdim256_32x32_8wave<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
            if constexpr (Is_balance) {
                compute_dq_dk_dv_1colblock_hdim256_32x32_8wave<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, true>(params, bidb, bidh, n_block_max - n_block - 1);
            }
        } else if constexpr (kHeadDim == 32) {
            compute_dq_dk_dv_1colblock_k32_blockN128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block);
            if constexpr (Is_balance) {
                compute_dq_dk_dv_1colblock_k32_blockN128<Kernel_traits, Is_dropout, Is_causal, Is_local, Has_alibi, Has_attn_mask, Is_even_MN, Is_even_K, Is_softcap, false, false, /*Seq_parallel=*/true>(params, bidb, bidh, n_block_max - n_block - 1);
            }
        } else if constexpr (kHeadDim == 160) {
            bidb = blockIdx.z;
            bidh = blockIdx.y;
