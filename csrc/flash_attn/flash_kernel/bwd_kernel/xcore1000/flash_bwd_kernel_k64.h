...
inline __device__ void compute_dq_dk_dv_1colblock_k64(const Params &params, const int bidb, const int bidh, const int n_block) {
    ...
    Tensor sV = make_tensor(sK.data() + size(sK), typename Kernel_traits::VarHeadDim::SmemLayoutV{});
    ...
    typename Kernel_traits::VarHeadDim::GmemTiledCopyK_4x2 gmem_tiled_copy_K_4x2;
    ...
    Tensor tKtsKt = make_tensor(make_smem_ptr(Ktsmem_ptr_sts), make_layout(Shape<_8, Int<size<1>(tKrK)>, Int<kHeadDimQ/kBlockKSmemQ>>{},
    ...
    Tensor tdQsKt = make_tensor(make_smem_ptr(Ktsmem_ptr_lds), make_layout(Shape<_4, Shape<Int<MMA_N_dQ>, Int<kHeadDimQ/kBlockKSmemQ>>, Int<MMA_K_dQ>>{},
                                                                            Stride<_1, Stride<Int<2*kBlockKSmemQ>,Int<kBlockN*kBlockKSmemQ>>, Int<16*kBlockKSmemQ>>{}));
    flash::sync_threads();
